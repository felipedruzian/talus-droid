...
Branch original deste relatorio: `report/2026-04-08-kinect-rtabmap-smoke`
...
Este relatorio foi o unico artefato versionado da rodada original na branch `report/2026-04-08-kinect-rtabmap-smoke`. Esta copia foi trazida para a branch tecnica atual apenas para manter os dois relatorios sob `docs/reports/`.
